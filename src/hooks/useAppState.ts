...
export function useAppState() {
  ...
  const completeOnboarding = useCallback((data: { ownBrand: Brand; competitors: Brand[]; prompts: Prompt[]; attributes?: Attribute[]; runScan?: boolean }) => {
